...
# SIGINT-Deck Raspberry Pi Build Script
...
echo -e "${CYAN}======================================${NC}"
echo -e "${CYAN} SIGINT-Deck Pi Build Script${NC}"
echo -e "${CYAN}======================================${NC}"
echo ""
...
echo -e "  Binary: $(ls -lh $INSTALL_DIR/sigint-deck | awk '{print $5}')"
...
echo "  cd $INSTALL_DIR && SIGINT_ACCEPT_DISCLAIMER=1 ./sigint-deck"
echo ""
